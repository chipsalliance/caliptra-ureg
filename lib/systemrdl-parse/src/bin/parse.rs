...
use ureg_systemrdl_parse::{ComponentType, EnumReference, InputFile, InstanceRef, ScopeType};
...
fn real_main() -> Result<(), Box<dyn Error>> {
    ...
    let scope = ureg_systemrdl_parse::Scope::parse_root(&files).map_err(|s| s.to_string())?;
