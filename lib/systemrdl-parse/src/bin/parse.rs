...
use ureg_systemrdl_parse::{ComponentType, EnumReference, FsFileSource, InstanceRef, ScopeType};
...
fn real_main() -> Result<(), Box<dyn Error>> {
    ...
    let scope = ureg_systemrdl_parse::Scope::parse_root(&fs, &files).map_err(|s| s.to_string())?;
